<template>
  <button
    class="flex justify-center bg-primary-color hover:bg-opacity-70 transition-colors duration-300 w-full items-center gap-4 rounded-md font-bold py-3 px-6"
  >
    <svg
