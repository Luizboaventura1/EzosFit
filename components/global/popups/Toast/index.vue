  ...
  <div id="wrapper-toast" class="absolute right-0 top-0 p-3">
    ...
    >
      <li
        ...
        :key="index"
        class="grid grid-cols-[auto,1fr,auto] gap-3 items-center w-[300px] h-full min-h-[55px] font-light bg-dark-charcoal border border-charcoal mb-1 shadow rounded-lg text-light-gray p-4 overflow-hidden"
      >
        <slot name="icon" />
...
const props = defineProps<{ toast: ToastInterface}>();
